...
public class TopologyCountTest {
    public static void main(String[] args) {
        ...
        //使用一个线程发送数据
        builder.setSpout("ReadLineSpout",new ReadLineSpout(),1).setNumTasks(4);
        //接受ReadLineSpout的数据
        builder.setBolt("SplitLineBolt",new SplitLineBolt(),2).setNumTasks(4).shuffleGrouping("ReadLineSpout");
        ...
        config.put("type","1");
//        config.setNumAckers(); //设置acker任务并行度 默认为1
//        config.setMessageTimeoutSecs(2);//任务超时设置
